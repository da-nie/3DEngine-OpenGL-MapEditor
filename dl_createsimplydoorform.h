#ifndef DL_CREATESIMPLYDOORFORM_H
#define DL_CREATESIMPLYDOORFORM_H
...
//------------------------------------------------------------------------------
class CDialog_CreateSimplyDoor
{
 public:
  //-----------------------------------------------------------
  HWND hDlg;
  ...
  CColorSet ColorSet;
  //-----------------------------------------------------------
  SSimplyDoor WorkingSector;
  int Flag;
  int SelectSector;
  SSimplyDoor Sector[5000];
  //-----------------------------------------------------------
  CDialog_CreateSimplyDoor(void);
  //-----------------------------------------------------------
